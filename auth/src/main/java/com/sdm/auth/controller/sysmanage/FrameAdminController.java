...
public class FrameAdminController {
    ...
    public String currentUser(HttpServletRequest request) {
        ...
        /**
         * { path: '/welcome', name: 'welcome', icon: 'smile', component: './Welcome', }, { path: '/admin', // 路径 name:
         * 'admin', icon: 'crown', // 图标 access: 'canAdmin', // 权限 component: './Admin', //配置 location 和 path 匹配后用于渲染的
         * React 组件路径。可以是绝对路径，也可以是相对路径，如果是相对路径，会从 src/pages 开始找起。 routes: [ //配置子路由，通常在需要为多个路径增加 layout 组件时使用。 { path:
         * '/admin/sub-page', name: 'sub-page', icon: 'smile', component: './Welcome', }, ], }, { name:
         * 'list.table-list', icon: 'table', path: '/list', component: './ListTableList', },
         * 
         * { name: '分析页', icon: 'smile', path: '/dashboardanalysis', component: './DashboardAnalysis', },
         */
